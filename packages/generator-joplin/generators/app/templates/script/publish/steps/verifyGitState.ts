 ...
 */
export async function verifyGitState(): Promise<string> {

	// Excecutes the git command silently and returns the output back to the calling statement
	...
	// Checks if there is any uncommited changes 
